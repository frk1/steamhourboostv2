...
var SteamAccount = function (_EventEmitter) {
  ...
  function SteamAccount(name, password, sentry, secret, games) {
    ...
    _this.logheader = _this.logheader.bind(_this);
    _this.error = _this.error.bind(_this);
    _this.login = _this.login.bind(_this);
    _this.logoff = _this.logoff.bind(_this);
    _this.boost = _this.boost.bind(_this);
    _this.restartGames = _this.restartGames.bind(_this);
    _this.name = name;
